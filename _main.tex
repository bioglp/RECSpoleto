...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figura 2.1 - Scheda delle fasi di lavoro e risultati cartografici attesi.}]{./figs/RECSpoleto_map03.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:fragIndex2f}Plot degli Indici fragstats per Classe geobotanica. Il codice della Classe è riportato all'interno del singolo punto. La dimensione dei punti è proporzionale al valore del Patch cohesion index.}]{_main_files/figure-latex/fragIndex2f-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:fragUrbano}Plot degli Indici fragstats per Classe geobotanica in Unità urbana. Il codice della Classe è riportato all'interno del singolo punto. La dimensione dei punti è proporzionale al valore del Patch cohesion index.}]{_main_files/figure-latex/fragUrbano-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:fragNoUrb}Plot degli Indici fragstats per Classe geobotanica nell'area non urbana. Il codice della Classe è riportato all'interno del singolo punto. La dimensione dei punti è proporzionale al valore del Patch cohesion index.}]{_main_files/figure-latex/fragNoUrb-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:plotSE}Relazione tra Splitting index ed Effective Meshsize. Con i colori e le etichette di testo sono evidenziate le diverse classi geobotaniche.}]{_main_files/figure-latex/plotSE-1.pdf}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1918}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2055}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2192}}
...
\item
  ...
  riqualificazione e manutenzione urbana. L'abaco fornirà indicazioni
...
\section{Layout diapositive}\label{layout-diapositive}
